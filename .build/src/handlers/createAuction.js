...
var createAuctionSchema_1 = require("../lib/schemas/createAuctionSchema");
var dynamodb = new aws_sdk_1.default.DynamoDB.DocumentClient();
function createAuction(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        var title, email, now, endDate, auction, error_1;
...
exports.handler = commonMiddleware_1.default(createAuction).use(validator_1.default({ inputSchema: createAuctionSchema_1.default }));
