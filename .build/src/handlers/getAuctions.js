...
var getAuctionsSchema_1 = require("../lib/schemas/getAuctionsSchema");
var dynamodb = new aws_sdk_1.default.DynamoDB.DocumentClient();
function getAuctions(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        var auctions, _a, status, params, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = event.queryStringParameters.status, status = _a === void 0 ? 'OPEN' : _a;
                    params = {
...
exports.handler = commonMiddleware_1.default(getAuctions).
    use(validator_1.default({ inputSchema: getAuctionsSchema_1.default, useDefault: true }));
